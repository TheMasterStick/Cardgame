...
describe("cardArtCandidates", () => {
  it("keeps the authored path first and falls back across supported formats", () => {
  ...
  it("preserves query/hash suffixes while changing extensions", () => {
    ...
    expect(candidates[0]).toBe("/cards/Test.webp?v=2#crop");
    expect(candidates).toContain("/cards/Test.png?v=2#crop");
